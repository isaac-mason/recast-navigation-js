...
export class OffMeshConnectionsHelper extends Entity {
    ...
    constructor(params: OffMeshConnectionsHelperParams) {
        ...
        this.entryCircleMaterial = params.entryCircleMaterial || new StandardMaterial();
        ...
        this.exitCircleMaterial = params.exitCircleMaterial || new StandardMaterial();
        ...
        this.lineMaterial = params.lineMaterial || new StandardMaterial();
    ...
    updateHelper() {
        ...
        for (const offMeshConnection of this.offMeshConnections) {
            ...
            const circleMesh = createCircleMesh(graphicsDevice, offMeshConnection.radius, 16);
            ...
            endCircleEntity.addComponent('render', {
                meshInstances: [
                    new MeshInstance(
                        circleMesh,
                        offMeshConnection.bidirectional ? this.entryCircleMaterial : this.exitCircleMaterial
                    ),
                ],
            });
            ...
            const middle = new Vec3().add2(start, end).scale(0.5);
 ...
 */
function createCircleMesh(graphicsDevice: GraphicsDevice, radius: number, segments: number): Mesh {

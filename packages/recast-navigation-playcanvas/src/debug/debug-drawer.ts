...
export class DebugDrawer extends Entity {
    ...
    constructor({ app, triMaterial, pointMaterial, lineMaterial }: DebugDrawerParams) {
        super();
    ...
    private endQuads(): void {
        ...
        for (let i = 0; i < this.currentVertices.length; i += 4) {
            ...
            colors.push(v0.r, v0.g, v0.b, v0.a, v1.r, v1.g, v1.b, v1.a, v2.r, v2.g, v2.b, v2.a);

            // Second triangle (v0, v2, v3)
            positions.push(v0.x, v0.y, v0.z, v2.x, v2.y, v2.z, v3.x, v3.y, v3.z);
            colors.push(v0.r, v0.g, v0.b, v0.a, v2.r, v2.g, v2.b, v2.a, v3.r, v3.g, v3.b, v3.a);
        }
 ...
 */
function createPointMesh(graphicsDevice: GraphicsDevice, positions: number[], colors: number[]): Mesh {
    ...
    const vertexBuffer = new VertexBuffer(graphicsDevice, vertexFormat, vertexCount, BUFFER_STATIC);
 ...
 * Creates a line mesh.
 */
function createLineMesh(graphicsDevice: GraphicsDevice, positions: number[], colors: number[]): Mesh {
    const vertexFormat = new VertexFormat(graphicsDevice, [
        { semantic: SEMANTIC_POSITION, components: 3, type: TYPE_FLOAT32 },
        { semantic: SEMANTIC_COLOR, components: 4, type: TYPE_FLOAT32 },
    ]);
 ...
 */
function createTriangleMesh(graphicsDevice: GraphicsDevice, positions: number[], colors: number[]): Mesh {
    const vertexFormat = new VertexFormat(graphicsDevice, [
        { semantic: SEMANTIC_POSITION, components: 3, type: TYPE_FLOAT32 },
        { semantic: SEMANTIC_COLOR, components: 4, type: TYPE_FLOAT32 },
    ]);
